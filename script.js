...
if(!activeDiamond){
    ...
    alert("⚠️ Pilih Nominal terlebih dahulu!");
...
buyBtn.innerHTML = "⏳ Memproses...";
    ...
    invoiceLogo.src = popupBanner.src;
...
setTimeout(()=>{
  ...
  if(status){
    ...
    status.innerHTML="🟡 Menunggu Pembayaran";
    ...
    setTimeout(()=>{
      ...
      status.innerHTML="💎 Diamond Berhasil Diproses";
...
if(calcBtn){
    ...
    calcBtn.onclick = ()=>{
        ...
        s.src = "https://pl29896660.effectivecpmnetwork.com/85/b5/c2/85b5c2fe6104b465c6e6f5bb4deb3a22.js";
        document.body.appendChild(s);

        // Hitung harga akun
        const diamond = Number(document.getElementById("diamondInput").value) || 0;

        const hasil = diamond * 145;
