...
document.getElementById("feedbackForm").addEventListener("submit", async(e)=>{
    ...
    const res = await fetch("https://discord.com/api/webhooks/1528395222051196959/s3YXI5cWTw66NCCtIvgu4Zp5Ucc7ccSz-AaNuz58a5NAIOFKopTsGVj5uOT7I-ZDgDSp", {
    method: "POST",
    ...
    document.getElementById("feedbackStatus").innerHTML=await res.text();
